...
function setLaunchEnabled(val) {
    launchEnabledBySelection = val
    updateLaunchButtonState()
}

function setLaunchInProgress(val) {
...
let mojangStatusListener = setInterval(() => refreshMojangStatuses(true), 60 * 1000)
// Set refresh rate to once every 5 minutes.
let serverStatusListener = setInterval(() => refreshServerStatus(true), 30 * 1000)
...
const GAME_LAUNCH_REGEX = /^\[.+\]: (?:MinecraftForge .+ Initialized|ModLauncher .+ starting: .+|Loading Minecraft .+ with Fabric Loader .+|NeoForge .+ Initialized)$/
